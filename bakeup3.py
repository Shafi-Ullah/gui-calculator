...
class calculator(ctk.CTk):
    ...
    def controle_button(self, frame):
        ...
        for text, row, column, width, height, rowspan in controle_button_position:
            ...
            controle_button_frame2.grid_rowconfigure(row, weight=1)
            controle_button_frame2.grid_columnconfigure(column, weight=1)
        controle_button_frame1.grid_rowconfigure(0, weight=1)
        controle_button_frame1.grid_columnconfigure(0, weight=1)
    ...
    def move_cursor_position(self, widget: str) -> None:
        ...
        # self.result_boolean = False
        # if self.focus_get() == self.equation_display:
        #     cursor_position = len(self.equation_list)
    ...
    def retrieve_equation_data(self, widget):
        ...
        if text == "" or self.result_boolean:
            ...
            if (len_database != self.count_equation_move and text == "\u25B4") or (
                ...
                # and database_line != self.count_equation_move
